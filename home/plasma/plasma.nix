{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Expose" = "Meta+Shift+W\\, Ctrl+F9\\, ,Ctrl+F9,Toggle Present Windows (Current desktop)";
      "kwin"."ExposeAll" = ["Meta+W,Ctrl+F10" "Launch (C),Toggle Present Windows (All desktops)"];
      ...
      "kwin"."Window to Next Desktop" = "Ctrl+Alt+Right,,Window to Next Desktop";
      "kwin"."Window to Next Screen" = "Meta+Shift+Right";
      "kwin"."Window to Previous Desktop" = "Ctrl+Alt+Left,,Window to Previous Desktop";
      ...
      "kwin"."view_zoom_in" = ["Meta++\\, Meta++" "Meta+=\\, Zoom In,Meta++" "Meta+=,Zoom In"];
      ...
      "services/net.local.wezterm.desktop"."_launch" = "Meta+Return";
    ...
    configFile = {
      ...
      "baloofilerc"."General"."foldersx5b$ex5d" = "$HOME/Documents/College/,$HOME/Documents/Documentation/";
      ...
      "kwinrc"."Script-polonium"."ResizeAmount" = 1;
      ...
      "kwinrc"."Tiling.7bbc8dda-5a00-51d9-85b5-6a97e711ce29"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      ...
      "kwinrc"."Tiling/07eea80a-9ecd-57e1-bea1-c03a37e433ad"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/213a9620-187e-58a6-b80b-85d8fb95dfce"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/23d84027-6b81-5a63-91b8-8e7e614d6fad"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/39d57435-c689-565f-9c9a-2c7ad9dd22d6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/3b09003e-31fd-5563-a5d0-e1df30d8aa4c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/5b6a9424-3221-5907-9c11-ead99d739c27"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/7bbc8dda-5a00-51d9-85b5-6a97e711ce29"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/7ebc10c3-b0af-5281-a973-4a6eae8a1adc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/934fd03a-38ac-54f0-a2fa-61823d0ca9d3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/af4e3df3-df4c-53b2-bbe7-d94ee2f2815c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/b490f0ea-ff25-5743-b36a-f61f427e8cc1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/bd455426-91b5-5aa4-b78c-9e21c3c810ab"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      "kwinrc"."Tiling/cc55641a-b969-52cd-87bf-88d4810033db"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/fed895cb-d61f-5091-bfa3-30f6fd4f0352"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
      ...
      "plasmanotifyrc"."Applications/com.github.marinm.songrec"."Seen" = true;
      ...
      "plasmanotifyrc"."Applications/opensnitch_ui"."Seen" = true;
      ...
      "spectaclerc"."General/$i"."clipboardGroup[$i]" = "PostScreenshotCopyImage";
      "spectaclerc"."General/$i"."onLaunchAction[$i]" = "UseLastUsedCapturemode";
