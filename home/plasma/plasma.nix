{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "bismuth"."focus_bottom_window" = "Meta+Down";
      "bismuth"."focus_left_window" = "Meta+Left";
      "bismuth"."focus_next_window" = [ ];
      "bismuth"."focus_prev_window" = [ ];
      "bismuth"."focus_right_window" = "Meta+Right";
      "bismuth"."focus_upper_window" = "Meta+Up";
    ...
    configFile = {
      ...
      "kwinrc"."Desktops"."Id_3" = "0b71d54e-014d-447a-b3c7-2cc7ce83d179";
      "kwinrc"."Desktops"."Id_4" = "f4ac4f7e-af96-4144-9b8b-e03d4414d939";
      ...
      "kwinrc"."Tiling.5b6a9424-3221-5907-9c11-ead99d739c27"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.5},{\"width\":0.5}]}";
